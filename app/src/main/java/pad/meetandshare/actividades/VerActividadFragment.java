...
public class VerActividadFragment extends Fragment {
    ...
    private static final String ARG_PARAM = "uidActividad";
    ...
    public static VerActividadFragment newInstance(String uidActividadRecived) {
        VerActividadFragment fragment = new VerActividadFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM, uidActividadRecived);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            uidActividad = getArguments().getString(ARG_PARAM);
        }
    }
